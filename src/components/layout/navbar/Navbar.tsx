...
const Navbar: FC = ({ }) => {
    ...
    return (
        <>
            <header className="border-b border-gray-300 bg-white min-h-[60px] px-10 py-3 tracking-wide relative z-50">
                <div className="flex flex-wrap items-center max-lg:gap-y-6 max-sm:gap-x-4">
                    <a href="javascript:void(0)">
                        ...
                        <img src="https://readymadeui.com/readymadeui-short.svg" alt="logo" className="w-9 h-9 hidden max-sm:block" />
                    </a>
                    ...
                    <div id="collapseMenu"
                        ...
                        <button onClick={handleToggle} id="toggleClose" className="lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white w-9 h-9 flex items-center justify-center border border-gray-200 cursor-pointer">
                ...
                <div
                    className="bg-gray-100 border border-transparent focus-within:border-slate-900 focus-within:bg-transparent flex items-center px-4 rounded-full h-10 lg:w-2/4 mt-3 mx-auto max-lg:mt-6 transition-all">
                    ...
                    <input type='email' placeholder='Search...'
                        className="w-full outline-none bg-transparent text-slate-900 text-[15px]" />
                </div>
            </header>
        </>
    );
